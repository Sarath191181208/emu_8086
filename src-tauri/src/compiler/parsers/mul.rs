use crate::compiler::{
    ...
    CompiledBytesReference, types_structs::{VariableReferenceMap, VariableAddressMap}, suggestions_utils::get_all_registers_and_variable_suggestions,
};
...
pub(in crate::compiler) fn parse_mul(
    ...
    let high_token = tokenized_line.get(
        ...
        Some(vec![get_all_registers_and_variable_suggestions(variable_address_map)])
    )?;
