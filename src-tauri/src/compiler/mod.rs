    ...
    match &token.token_type {
        ...
        Assembly8086Tokens::Instruction(ins) => match ins {
            ...
            Instructions::Jp => {
                ...
                // compiled_line.extend(_compliled_line);
                error_if_hasnt_consumed_all_ins(&lexed_str_without_spaces, i, "Jp", 1)?;
                Ok(compiled_line)
            }
            ...
            Instructions::Jpe => {
                ...
                // compiled_line.extend(_compliled_line);
                error_if_hasnt_consumed_all_ins(&lexed_str_without_spaces, i, "JPE", 1)?;
                Ok(compiled_line)
            }
            ...
            Instructions::Jpo => {
                ...
                // compiled_line.extend(_compliled_line);
                error_if_hasnt_consumed_all_ins(&lexed_str_without_spaces, i, "JPO", 1)?;
                Ok(compiled_line)
            }
            ...
            Instructions::Js => {
                ...
                // compiled_line.extend(_compliled_line);
                error_if_hasnt_consumed_all_ins(&lexed_str_without_spaces, i, "JS", 1)?;
                Ok(compiled_line)
            }
            ...
            Instructions::Jz => {
                ...
                // compiled_line.extend(_compliled_line);
                error_if_hasnt_consumed_all_ins(&lexed_str_without_spaces, i, "JZ", 1)?;
                Ok(compiled_line)
            }
