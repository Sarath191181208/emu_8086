...
<LabeledInstructionAddressinng instructionName="JNC" />
...
ex: `JNC 0x100` is equivalent to `JNB 0x03` + `JMP 0x100`. Here 0x03 is the size of the 16bit jmp instruction [0xE9, 0x00, 0x01].
:::
